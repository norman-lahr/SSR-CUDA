...
SRCDIR     ?= 
ROOTDIR    ?= /home/cuda/NVIDIA_GPU_Computing_SDK/C/common
ROOTBINDIR ?= ./bin
...
# add subdirectories for SSR Project
	$(VERBOSE)mkdir -p $(foreach DIR, $(dir $(CUFILES)), $(OBJDIR)/$(DIR))
	$(VERBOSE)mkdir -p $(foreach DIR, $(dir $(CCFILES)), $(OBJDIR)/$(DIR))
